...
--
-- Table structure for table `bowhead_ohlc_tick`
--

DROP TABLE IF EXISTS `bowhead_ohlc_tick`;
...
--
-- Dumping data for table `bowhead_ohlc_tick`
--

LOCK TABLES `bowhead_ohlc_tick` WRITE;
/*!40000 ALTER TABLE `bowhead_ohlc_tick` DISABLE KEYS */;
/*!40000 ALTER TABLE `bowhead_ohlc_tick` ENABLE KEYS */;
UNLOCK TABLES;
