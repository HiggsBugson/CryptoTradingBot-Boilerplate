...
import json
import configparser
from lib.pywhale.connection.Api import Api
from lib.pywhale.trade.General import General
from lib.pywhale.trade.Live import Live
from lib.pywhale.trade.Turbo import Turbo
...
class PyWhale(Api,General,Live,Turbo):
	...
	def __init__(self, start_url = 'https://api.whaleclub.co/v1/'):
		...
		self.default_key = config.get('whaleclub','api_key')

		Api.__init__(self, BTC_demo_key=self.default_key) # inherit token from API class for our connection class instance
